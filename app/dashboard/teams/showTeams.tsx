...
export default function ShowTeams({
    ...
    const [selectedTeamId, setSelectedTeamId] = useState<string>(initialTeamId ? String(initialTeamId) : "");
    ...
    return (
        ...
        <Card>
            ...
            {!selectedTeamId ? (
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {members.map((m) => (
                    <div key={m.userId} className="rounded-lg border p-3 flex items-center gap-3">
                    ...
                    member={m}
                    onChange={async () => {
                        const updatedMembers = await getTeamMembers(Number(selectedTeamId));
